...
class Ergasia{
 ...
 Pelatis_Trapezas pel_tr=new Pelatis_Trapezas(name, ypol, kod_kin, poso_kin, neo_ypol );
 pel_tr.setName(name);
 pel_tr.setYpol(ypol);
 pel_tr.setPosokin(poso_kin);
 pel_tr.setKodkin(kod_kin);
 pel_tr.setNeoypol(neo_ypol);
